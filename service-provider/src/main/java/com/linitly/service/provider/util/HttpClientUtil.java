...
public class HttpClientUtil {
    ...
    public String sendHttpPostFile(String httpUrl, Map<String, String> maps, MultipartFile multipartFile) {
        try {
            log.info("【请求地址】" + httpUrl);
            File file = new File("upload_temp-" + multipartFile.getOriginalFilename());
     ...
     * @return
     */
    public String sendHttpPostJson(String httpUrl, Object object) {
