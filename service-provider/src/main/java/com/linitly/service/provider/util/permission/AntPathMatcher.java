...
public class AntPathMatcher implements PatternMatcher {
    ...
    protected boolean doMatch(String pattern, String path, boolean fullMatch) {
        ...
        String[] pattDirs = ShiroStringUtil.tokenizeToStringArray(pattern, this.pathSeparator);
        String[] pathDirs = ShiroStringUtil.tokenizeToStringArray(path, this.pathSeparator);
    ...
    public String extractPathWithinPattern(String pattern, String path) {
        String[] patternParts = ShiroStringUtil.tokenizeToStringArray(pattern, this.pathSeparator);
        String[] pathParts = ShiroStringUtil.tokenizeToStringArray(path, this.pathSeparator);
